...
public class DoubleLinkedList<T> {
    ...
    public void sort() {
        ...
        while (current != null) {
            T key = current.data;
            Node<T> jNode = current.prev;

            while (jNode != null && ((Comparable<T>)key).compareTo(jNode.data) < 0) {
                jNode = jNode.prev;
            }
            ...
            if (jNode == null) {
                ...
                current.next = jNode.next;
                current.prev = jNode;
                jNode.next.prev = current;
                jNode.next = current;
            }
